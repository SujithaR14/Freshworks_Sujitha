...
// This file which containes the data store and the supporting functions can be included in any other programs as api or as a library file
...
// Creating a class name suji which acts as a container for our data store type
class suji
{
